...
class _OrganicWalletCardBorderPainter extends CustomPainter {
  const _OrganicWalletCardBorderPainter({
    required this.color,
  ...
  void paint(Canvas canvas, Size size) {
    final path = const _OrganicWalletCardClipper().getClip(size);
    final paint = Paint()
      ..color = color
  ...
  @override
  bool shouldRepaint(covariant _OrganicWalletCardBorderPainter oldDelegate) =>
