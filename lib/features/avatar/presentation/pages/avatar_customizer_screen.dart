...
class _AvatarCustomizerScreenState
  ...
  Future<void> _loadExistingCustomization() async {
    ...
    setState(() {
      ...
      _hasAvatar =
          avatarUrl != null && avatarUrl.isNotEmpty && avatarUrl != 'SKIPPED';
      final elements = (data?['avatar_elements'] as Map<String, dynamic>?)
          ?.cast<String, String>();
      final colors = (data?['avatar_colors'] as Map<String, dynamic>?)
          ?.cast<String, String>();
