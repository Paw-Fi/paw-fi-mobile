...
class AccountsPage extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final preferredCurrency =
        analytics.contact?.preferredCurrency?.toUpperCase() ?? 'USD';

    final scopedExpenses = analytics.allExpenses.where((expense) {
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  '$symbol${formatLocalizedNumber(context, double.parse(formatAmount(netWorth)))} $currencyCode',
                  style: TextStyle(
                    color: colorScheme.foreground,
                    fontSize: 32,
...
class _OrganicAccountTileClipper extends CustomClipper<Path> {
  ...
  Path getClip(Size size) {
    ...
    final double cpOffset = curveWidth * 0.45; // Creates a smooth curve interpolation
