...
class RecurringHistoryPage extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final fullRangeTimeline = userId.isEmpty
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          _buildStatItem(
                            ...
                            value:
                                formatLocalizedDate(context, nextDueOccurrence),
                          ),
                        ],
                      ),
                    ],
                ...
                child: Row(
                  children: [
                    _buildFilterChip(
                      ...
                      isSelected: activeFilter.value == _HistoryFilter.all,
                      count: occurrences.length,
                      onTap: () => activeFilter.value = _HistoryFilter.all,
                    ),
                    ...
                    _buildFilterChip(
                      ...
                      isSelected: activeFilter.value == _HistoryFilter.paid,
                      count: paidCyclesCount,
                      onTap: () => activeFilter.value = _HistoryFilter.paid,
                    ),
                    const SizedBox(width: 8),
                    _buildFilterChip(
                      context,
                      ...
                      isSelected: activeFilter.value == _HistoryFilter.pending,
                      count: occurrences.length - paidCyclesCount,
                      onTap: () => activeFilter.value = _HistoryFilter.pending,
                    ),
                  ],
                ),
              ),
                ...
                sliver: SliverList(
                  delegate: SliverChildBuilderDelegate(
                    (context, index) {
                      ...
                      final isFutureReference = futureReference != null &&
                      ...
                      final daysDifference =
                          occurrenceDateOnly.difference(userToday).inDays;
                      final isOverdue = daysDifference < 0 && !isConfirmed;
                      ...
                      final String dueText = daysDifference == 0
                          ...
                          : daysDifference == 1
                              ...
                              : daysDifference > 1
                                  ? context.l10n.dueInDaysStatus(daysDifference)
                                  : context.l10n
                                      .overdueByDaysStatus(-daysDifference);
                      ...
                      final paidDateFormatted = paidDate != null
                          ...
                          : null;
                      final confirmedDateText = timelineItem?.isImported == true
                          ? 'Imported payment'
                          : (paidDate != null &&
                                  formatDateOnlyYmd(paidDate) != dateString)
                              ? context.l10n.paidStatusOn(paidDateFormatted!)
                              : context.l10n.paid;
                      ...
                      final onTileTap = isConfirmed
                          ? () => showConfirmRecurringOccurrenceSheet(
                                ...
                                existingOccurrence: timelineItem,
                              )
                              ...
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(14),
                                    border: Border.all(
                                      color: isUpcoming && !isConfirmed
                                          ? (isOverdue
                                              ? colorScheme.destructive
                                                  .withValues(alpha: 0.4)
                                              : colorScheme.primary
                                                  .withValues(alpha: 0.4))
                                          : colorScheme.homeCardBorder,
                                      width: 1,
                                    ),
                                    boxShadow: [
                                      BoxShadow(
