...
class PreviewMockData {
  ...
  static final List<ExpenseEntry> _expenses = [
    ...
    ExpenseEntry(
      ...
      rawText: 'Workday coffee and pastry',
      type: 'expense',
      isRecurring: false,
    ),
    ExpenseEntry(
      id: 'preview-expense-33',
      contactId: contact.id,
      userId: contact.userId,
      householdId: null,
      ...
      rawText: 'Chef counter dinner',
      type: 'expense',
      isRecurring: false,
    ),
    ExpenseEntry(
      id: 'preview-expense-34',
      contactId: contact.id,
      userId: contact.userId,
      householdId: null,
      ...
      rawText: 'Train pass top-up',
      type: 'expense',
      isRecurring: false,
    ),
    ExpenseEntry(
      id: 'preview-expense-35',
      contactId: contact.id,
      userId: contact.userId,
      householdId: null,
      date: DateTime.now().subtract(const Duration(days: 12, hours: 3)),
      amountCents: 11200,
      currency: 'USD',
      category: 'Home',
      createdAt: DateTime.now().subtract(const Duration(days: 12, hours: 3)),
      rawText: 'Kitchen refresh supplies',
      type: 'expense',
      isRecurring: false,
    ),
    ExpenseEntry(
      id: 'preview-expense-36',
      contactId: contact.id,
      userId: contact.userId,
      householdId: null,
      date: DateTime.now().subtract(const Duration(days: 14, hours: 5)),
      amountCents: 4200,
      currency: 'USD',
      category: 'Entertainment',
      createdAt: DateTime.now().subtract(const Duration(days: 14, hours: 5)),
      rawText: 'Concert tickets deposit',
      type: 'expense',
      isRecurring: false,
    ),
    ExpenseEntry(
      id: 'preview-expense-37',
      contactId: contact.id,
      userId: contact.userId,
      householdId: null,
      date: DateTime.now().subtract(const Duration(days: 17, hours: 1)),
      amountCents: 2750,
      currency: 'USD',
      category: 'Groceries',
      createdAt: DateTime.now().subtract(const Duration(days: 17, hours: 1)),
      rawText: 'Farm box delivery',
      type: 'expense',
      isRecurring: false,
    ),
    ExpenseEntry(
      id: 'preview-expense-38',
      contactId: contact.id,
      userId: contact.userId,
      householdId: null,
      date: DateTime.now().subtract(const Duration(days: 20, hours: 6)),
      amountCents: 9200,
      currency: 'USD',
      category: 'Shopping',
      createdAt: DateTime.now().subtract(const Duration(days: 20, hours: 6)),
      rawText: 'Capsule wardrobe refresh',
      type: 'expense',
      isRecurring: false,
    ),
    ExpenseEntry(
      id: 'preview-expense-39',
      contactId: contact.id,
      userId: contact.userId,
      householdId: null,
      date: DateTime.now().subtract(const Duration(days: 23, hours: 4)),
      amountCents: 3100,
      currency: 'USD',
      category: 'Wellness',
      createdAt: DateTime.now().subtract(const Duration(days: 23, hours: 4)),
      rawText: 'Massage therapy copay',
      type: 'expense',
      isRecurring: false,
    ),
    ExpenseEntry(
      id: 'preview-expense-40',
      contactId: contact.id,
      userId: contact.userId,
      householdId: null,
      date: DateTime.now().subtract(const Duration(days: 26, hours: 8)),
      amountCents: 5400,
      currency: 'USD',
      category: 'Travel',
      createdAt: DateTime.now().subtract(const Duration(days: 26, hours: 8)),
      rawText: 'Weekend rail tickets',
      type: 'expense',
      isRecurring: false,
    ),
  ];
