...
class AppLocalizationsPks extends AppLocalizations {
  ...
  @override
  String get enterValidAmountGreaterThan0 => 'براہ کرم 0 سے زیادہ درست رقم درج کریں';
  ...
  @override
  String get shareWithHousehold => 'گھرانے کے ساتھ شیئر کریں';
  ...
  @override
  String get failedToSendReminderTryAgain => 'یاد دہانی بھیجنے میں ناکامی۔ براہ کرم دوبارہ کوشش کریں۔';
  ...
  @override
  String get incomeAdded => 'آمدنی کامیابی سے شامل کر دی گئی';

  @override
  String get noIncome => 'ابھی تک کوئی آمدنی نہیں';

  @override
  String get noIncomeDescription => 'اپنے گھر کی مالی صحت کو ٹریک کرنے کے لیے اپنی آمدنی ریکارڈ کریں';

  @override
  String get totalIncome => 'کل آمدنی';

  @override
  String get monthToDate => 'مہینہ تا تاریخ';

  @override
  String get yearToDate => 'سال تا تاریخ';

  @override
  String get failedToLoadIncome => 'آمدنی لوڈ کرنے میں ناکام';

  @override
  String get incomeAcknowledged => 'آمدنی تسلیم کر لی گئی';

  @override
  String get acknowledge => 'تسلیم کریں';

  @override
  String get acknowledged => 'تسلیم کر لیا گیا';

  @override
  String get source => 'ذریعہ';

  @override
  String get sourceHint => 'مثلاً: آجر، کلائنٹ';
  ...
  @override
  String get privacyScope => 'رازداری';

  @override
  String get privacyFull => 'مکمل تفصیلات';

  @override
  String get privacyBalancesOnly => 'صرف بیلنس';

  @override
  String get privacyPrivate => 'نجی';

  @override
  String get privacyFullExplanation => 'پارٹنر رقم، ذریعہ اور تفصیل سمیت تمام تفصیلات دیکھ سکتا ہے۔';

  @override
  String get privacyBalancesOnlyExplanation => 'پارٹنر یہ آمدنی کل میں دیکھ سکتا ہے لیکن تفصیلات نہیں (ذرائع، تفصیل پوشیدہ)۔';

  @override
  String get privacyPrivateExplanation => 'صرف آپ ہی یہ آمدنی دیکھ سکتے ہیں۔ یہ گھریلو کل میں حصہ ڈالتی ہے لیکن پارٹنر تفصیلات نہیں دیکھ سکتا۔';

  @override
  String get incomeSalary => 'تنخواہ';

  @override
  String get incomeFreelance => 'فری لانس';

  @override
  String get incomeInvestment => 'سرمایہ کاری';

  @override
  String get incomeRefund => 'واپسی';

  @override
  String get incomeGift => 'تحفہ';

  @override
  String get incomeBonus => 'بونس';

  @override
  String get incomeRental => 'کرایہ';

  @override
  String get incomeOther => 'دیگر';

  @override
  String get goals => 'مقاصد';

  @override
  String get createGoal => 'مقصد بنائیں';

  @override
  String get goalCreated => 'مقصد کامیابی سے بنایا گیا';

  @override
  String get goalTitle => 'مقصد کا عنوان';

  @override
  String get enterGoalTitle => 'مقصد کا عنوان درج کریں';
  ...
  @override
  String get invalidAmount => 'براہ کرم 0 سے زیادہ درست رقم درج کریں';

  @override
  String get targetAmount => 'ہدف رقم';

  @override
  String get currentAmount => 'موجودہ رقم';

  @override
  String get targetDate => 'ہدف تاریخ';

  @override
  String get description => 'تفصیل';

  @override
  String get descriptionHint => 'نوٹ (اختیاری)';

  @override
  String get savings => 'بچت';

  @override
  String get paydown => 'قرض ادائیگی';
  ...
  @override
  String get offTrack => 'ٹریک سے باہر';

  @override
  String get onTrack => 'ٹریک پر';

  @override
  String get complete => 'مکمل کریں';

  @override
  String get overallProgress => 'کل پیشرفت';

  @override
  String get totalGoals => 'کل مقاصد';

  @override
  String get noGoals => 'ابھی تک کوئی مقصد نہیں۔ شروع کرنے کے لیے اپنا پہلا مقصد بنائیں!';

  @override
  String get noSavingsGoals => 'ابھی تک کوئی بچت کا مقصد نہیں۔ بچت شروع کرنے کے لیے ایک بنائیں!';

  @override
  String get noPaydownGoals => 'ابھی تک کوئی ادائیگی کا مقصد نہیں۔ قرض کم کرنے شروع کرنے کے لیے ایک بنائیں!';

  @override
  String get goalAcknowledged => 'مقصد تسلیم کر لیا گیا';

  @override
  String get balancesOnly => 'صرف بیلنس';

  @override
  String get contribution => 'جمع';

  @override
  String get withdrawal => 'رقم نکالنا';
  ...
  @override
  String get addContribution => 'جمع کریں';

  @override
  String get contributionAmount => 'جمع کی رقم';

  @override
  String get contributionType => 'قسم';

  @override
  String get contributionAdded => 'جمع کامیابی سے شامل کر دی گئی';
}
