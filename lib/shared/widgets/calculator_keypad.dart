              ...
              children: [
                _buildRow([
                  _buildKey('AC',
                      ...
                      width: keyWidth),
                  _buildKey('÷',
                      variant: _KeyVariant.operator, width: keyWidth),
                  _buildKey('×',
                      icon: Icons.close,
                      variant: _KeyVariant.operator,
                      width: keyWidth),
                  _buildKey('backspace',
                ...
                _buildRow([
                  _buildKey('7', width: keyWidth),
                  _buildKey('8', width: keyWidth),
                  _buildKey('9', width: keyWidth),
                  _buildKey('-',
                      icon: Icons.remove,
                      variant: _KeyVariant.operator,
                      width: keyWidth),
                ...
                const SizedBox(height: 12),
                _buildRow([
                  _buildKey('4', width: keyWidth),
                  _buildKey('5', width: keyWidth),
                  _buildKey('6', width: keyWidth),
                  _buildKey('+',
                      icon: Icons.add,
                      variant: _KeyVariant.operator,
                      width: keyWidth),
                ...
                const SizedBox(height: 12),
                _buildRow([
                  _buildKey('1', width: keyWidth),
                  _buildKey('2', width: keyWidth),
                  _buildKey('3', width: keyWidth),
                  _buildKey('=',
                      variant: _KeyVariant.operator, width: keyWidth),
                ]),
                const SizedBox(height: 12),
                _buildRow([
                  _buildKey('.', label: _decimalSeparator, width: keyWidth),
                  _buildKey('0', width: keyWidth),
                  _buildKey('Done',
                      icon: Icons.check,
